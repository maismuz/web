...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profissao', models.CharField(help_text='Profissão atual.', max_length=100, verbose_name='Profissão')),
                ('bio', models.TextField(blank=True, help_text='Breve descrição profissional.', null=True, verbose_name='Biografia')),
            ],
            options={
                'verbose_name': 'Informação Profissional',
                'verbose_name_plural': 'Informações Profissionais',
            },
        ),
        migrations.CreateModel(
            name='RedeSocial',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_nascimento', models.DateField(validators=[apps.core.models.validate_date_of_birth], verbose_name='Data de Nascimento')),
                ...
                ('endereco', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='perfil', to='core.endereco')),
                ('informacao_profissional', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='perfil', to='core.informacaoprofissional')),
                ...
                ('rede_social', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='perfil', to='core.redesocial')),
            ],
            options={
                'verbose_name': 'Perfil',
