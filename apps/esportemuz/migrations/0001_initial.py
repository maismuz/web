# Generated by Django 5.2 on 2025-05-14 17:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(max_length=255, unique=True, verbose_name='Nome')),
                ('escudo', models.ImageField(blank=True, null=True, upload_to=esportemuz.models.Equipe.get_path_escudo, verbose_name='Escudo')),
            ],
            options={
                'verbose_name': 'Equipe',
