# Generated by Django 5.2.1 on 2025-07-09 17:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('localizacao', models.CharField(blank=True, max_length=200, null=True, verbose_name='Descrição ou endereço')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passageiros_estimados', models.PositiveIntegerField(default=0, verbose_name='Nº de passageiros')),
                ...
                ('ponto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movemuz.ponto', verbose_name='Ponto')),
            ],
            options={
                'verbose_name': 'Parada',
        ...
        migrations.AddField(
            ...
            name='veiculo',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='movemuz.veiculo', verbose_name='Veículo'),
        ),
        migrations.CreateModel(
            name='EscalaVeiculo',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('motorista', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movemuz.motorista_movemuz', verbose_name='motorista')),
